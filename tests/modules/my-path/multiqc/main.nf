...
include { FASTQC            } from '../../../../modules/my-path/fastqc/main.nf'
include { FASTQC as FASTQC2 } from '../../../../modules/my-path/fastqc/main.nf'
include { MULTIQC           } from '../../../../modules/my-path/multiqc/main.nf'
