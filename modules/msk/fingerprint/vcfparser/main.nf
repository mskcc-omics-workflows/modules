process FINGERPRINT_VCFPARSER {
    ...
    tuple val("${task.process}"), val('parse_fingerprint_vcf.py'), eval('parse_fingerprint_vcf.py -v | cut -f 2 -d" "'), emit: versions_vcfparser, topic: versions
